...
#warning Incomplete method implementation.
    ...
    return [self.delegate.waves count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Wave *wave = [self.delegate.waves objectAtIndex:indexPath.row];
...
//    NSLo
    ...
    DetailSettingsTableViewController *detailViewController = [[DetailSettingsTableViewController alloc] initWithStyle:UITableViewStyleGrouped];
